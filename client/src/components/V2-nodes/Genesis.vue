  ...
  <div>
    <div class="genesis-content">
      <el-form 
        ...
        >
          <el-input v-model="tokenName.value" class="genesis-edit-input" size="small"></el-input>
        </el-form-item>
        ...
        >
          <el-input v-model="tokenAmount.value" class="genesis-edit-input" size="small"></el-input>
