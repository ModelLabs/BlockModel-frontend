    ...
    <el-collapse-transition>
      <div class="visual-panel">
        ...
        <div class="charts-container">
            <el-form 
                :model="dynamicDashboardForm" 
                ref="dynamicDashboardForm" 
                label-width="70px">

                <el-form-item
                class="form-item"
                v-for="(dashboard, index) in dynamicDashboardForm.dashboard"
                :label="'dashboard' + index"
                :key="dashboard.key"
                :prop="'dashboard.' + index + '.value'"
                :rules="{
                    required: true, message: 'Please input tokenName', trigger: 'blur'
                }"
                >
                    <el-input v-model="dashboard.value" class="stakeholder-edit-input" size="small"></el-input>
                </el-form-item>

                <el-form-item class="form-item">
                    <el-button @click="addNew" class="add-button" size="mini">+</el-button>
                    <!-- <el-button 
                        @click="submitForm('dynamicDashboardForm')" 
                        class="submit-button" 
