import {
    ...
    SET_MODEL, SET_EDIT_CELLS, REMOVE_CELLS, SET_WEB3_PROVIDER, SET_USER, SET_USER_EMAIL, SET_EDIT_RULE, SAVE_EDIT_RULE, LOAD_RULE_LISTS,
    ...
    ADD_MINT_NODES,ADD_MINT_EDGES,ADD_SELECT_NODES_DATA,ADD_SELECT_VISUAL_DATA,ADD_SELECT_PROPERTY_DATA,CHANGE_SIMULATING
...
Vue.use(Vuex)
export default {
    [CHANGE_SIMULATING](state, val) {
        state.simulating = val;
    },
